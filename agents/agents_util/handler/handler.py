...
class BaseHandler:
    ...
    def __init__(self, model_name, temperature=0.0, top_p=1, max_tokens=16000) -> None:
    ...
    def agent(self, prompt, functions, test_category):
        # This method is used to retrieve model response for each model.
        pass
